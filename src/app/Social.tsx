        ...
        <div className='footer'>
            ...
            <div className='footer-colum'>
                <ul className='ul-footer'>
                    ...
                    <li className='link-footer'  ><a href="https://github.com/Pedro-maciel-pinheiro" target='blank'><FaGithub /></a></li>

                    <li className='link-footer'  ><a href="mailto:shionlk98@gmail.com" target='blank'><MdEmail /></a></li>
